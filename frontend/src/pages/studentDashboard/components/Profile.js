    ...
    <div className="profile-container">
      ...
      <div className="pl-8 pr-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mt-6 sm:mt-0 mb-8">
          ...
          <button onClick={() => navigate('/profile')} className="mt-4 sm:mt-0 px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors shadow-sm flex items-center justify-center">
