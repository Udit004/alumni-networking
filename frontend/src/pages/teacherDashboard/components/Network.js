...
const TeacherNetwork = ({ currentUser, isDarkMode }) => {
      ...
      <div key={cardKey} className="bg-white dark:bg-gray-800 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700">
        <div className="p-4 md:p-5">
            ...
            <div className="flex-1 min-w-0 text-center sm:text-left">
              ...
              {expertise.length > 0 && (
                <div className="mt-2 flex flex-wrap justify-center sm:justify-start gap-1.5">
                  {expertise.slice(0, isMobile ? 2 : 3).map((skill, index) => (
                    <span
          ...
          <div className="mt-4 flex justify-center sm:justify-end gap-2">
            {isIncomingRequest && (
              <div className="flex flex-col xs:flex-row w-full sm:w-auto gap-2">
                <button
                  ...
                  className="px-4 py-2.5 bg-green-500 text-white text-sm font-medium rounded-lg hover:bg-green-600 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 w-full xs:w-auto text-center"
                >
                  Accept
                </button>
                <button
                  onClick={() => handleDecline(requestId)}
                  className="px-4 py-2.5 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 w-full xs:w-auto text-center"
                >
                  Decline
                </button>
              </div>
            ...
            {isOutgoingRequest && (
              <span className="px-4 py-2.5 text-sm font-medium text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20 rounded-lg flex items-center justify-center w-full sm:w-auto">
            ...
            {!isIncomingRequest && !isOutgoingRequest && !isConnection && (
              <button
                ...
                className="px-4 py-2.5 bg-blue-500 text-white text-sm font-medium rounded-lg hover:bg-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 flex items-center justify-center w-full sm:w-auto"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {isConnection && (
              <span className="px-4 py-2.5 text-sm font-medium text-green-700 dark:text-green-400 bg-green-50 dark:bg-green-900/20 rounded-lg flex items-center justify-center w-full sm:w-auto">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-2 sm:p-4">
      <div className="max-w-full mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-4 md:p-6">
          {/* Header */}
          <div className="mb-4 md:mb-6">
            <h1 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white mb-2">Professional Network</h1>
          ...
          <div className="flex border-b border-gray-200 dark:border-gray-700 mb-4 md:mb-6 overflow-x-auto pb-px">
            <button
              onClick={() => setActiveTab('connections')}
              className={`px-3 md:px-5 py-2.5 md:py-3 font-medium text-xs md:text-sm whitespace-nowrap flex-shrink-0 ${
            ...
            >
              ...
              {pendingRequests.incoming.length > 0 && (
                <span className="ml-1.5 inline-flex items-center justify-center px-2 py-0.5 text-xs font-bold leading-none text-white bg-red-500 rounded-full absolute -top-1 -right-1">
          ...
          {/* Error State */}
          {error && (
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-4 mb-4 md:mb-6">
              <div className="flex">
            ...
            <div className="space-y-4 md:space-y-6">
                ...
                <div>
                  {connections.length > 0 ? (
                    ...
                    <div className="text-center py-8 md:py-16">
                      <div className="bg-blue-50 dark:bg-blue-900/20 w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6">
                        <svg className="w-8 h-8 md:w-10 md:h-10 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                      </div>
                      <h3 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mb-2">No connections yet</h3>
                      <p className="text-gray-600 dark:text-gray-400 mb-4 md:mb-6 max-w-md mx-auto">Start building your professional network by connecting with students, alumni, and other educators.</p>
                      <button
                        onClick={() => setActiveTab('recommendations')}
                        className="px-4 py-2.5 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 font-medium"
                      >
                ...
                <div>
                  {recommendations.length > 0 ? (
                    ...
                    <div className="text-center py-8 md:py-16">
                      ...
                      <h3 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mb-2">No recommendations</h3>
              ...
              {activeTab === 'pending' && (
                <div className="space-y-6 md:space-y-8">
                  ...
                  {pendingRequests.incoming.length > 0 && (
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3 md:mb-4 px-1">Incoming Requests</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-3 md:gap-6">
                  ...
                  {pendingRequests.outgoing.length > 0 && (
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3 md:mb-4 px-1">Outgoing Requests</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-3 md:gap-6">
                  ...
                  {pendingRequests.incoming.length === 0 && pendingRequests.outgoing.length === 0 && (
                    <div className="text-center py-8 md:py-16">
                      <div className="bg-green-50 dark:bg-green-900/20 w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center mx-auto mb-4 md:mb-6">
                        <svg className="w-8 h-8 md:w-10 md:h-10 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 13l4 4L19 7" />
                        </svg>
                      </div>
                      <h3 className="text-lg md:text-xl font-semibold text-gray-900 dark:text-white mb-2">All caught up!</h3>
