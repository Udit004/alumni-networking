    ...
    <div className="alumni-profile">
      ...
      <div className="bg-blue-600 dark:bg-blue-800 rounded-t-lg p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">{profileData?.name || "Alumni Name"}</h2>
              <p className="text-blue-100">alumni</p>
              <p className="text-blue-100">{profileData?.email || "alumni@example.com"}</p>
            </div>
          </div>
          <button
      ...
      <div className="bg-white dark:bg-gray-800 rounded-b-lg shadow-md p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Job Title</h3>
            <div className="p-2 bg-gray-100 dark:bg-gray-700 rounded-md">
              {profileData?.currentPosition || "Not provided"}
            </div>
          </div>
