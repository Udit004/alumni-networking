    ...
    const fetchAlumniProfile = async () => {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          // Verify this is an alumni profile
          if (profileData.role !== 'alumni') {
            setError('This user is not an alumni.');
          } else {
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="text-center p-6 max-w-md bg-white dark:bg-gray-800 rounded-lg shadow-md">
          ...
          <button 
            onClick={() => navigate('/directory/alumni')} 
    ...
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-50 dark:bg-gray-900">
        <div className="text-center p-6 max-w-md bg-white dark:bg-gray-800 rounded-lg shadow-md">
          ...
          <p className="text-gray-700 dark:text-gray-300">The requested alumni profile could not be found.</p>
          <button 
            onClick={() => navigate('/directory/alumni')} 
            className="mt-4 px-4 py-2 bg-primary text-white rounded-md hover:bg-opacity-90"
          >
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start">
              ...
              <div className="mb-4 md:mb-0 md:mr-6">
                {profile.photoURL ? (
                  ...
                  <div className="h-32 w-32 rounded-full bg-primary flex items-center justify-center text-white text-4xl font-semibold">
              ...
              <div className="flex-1 text-center md:text-left">
                <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">
                  {profile.name || 'Alumni Name'}
                </h1>
                <p className="text-xl text-primary dark:text-primary-light font-medium mt-1">
                  {profile.jobTitle || 'Position'}
                </p>
                <p className="text-gray-600 dark:text-gray-400 mt-1">
                  {profile.company && `at ${profile.company}`} {profile.location && `• ${profile.location}`}
                </p>
              ...
              <div className="mt-6 md:mt-0 md:ml-6 flex flex-col space-y-2">
                <button 
                  ...
                  className="px-4 py-2 bg-primary text-white rounded-md hover:bg-opacity-90 flex items-center justify-center"
                >
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button 
                  ...
                  className="px-4 py-2 border border-primary text-primary dark:text-primary-light rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center justify-center"
                >
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {activeSection === 'experience' && (
            <div>
              ...
              {profile.workExperience && profile.workExperience.length > 0 ? (
                ...
                <p className="text-gray-600 dark:text-gray-400">No work experience information available.</p>
              )}
            </div>
          )}
                    ...
                    <div key={index} className="border-b border-gray-200 dark:border-gray-700 pb-6 last:border-0 last:pb-0">
                      <div className="flex flex-col md:flex-row md:justify-between md:items-start">
                        <div>
                          ...
                          <p className="text-primary dark:text-primary-light">{edu.institution}</p>
                        </div>
                        <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 md:mt-0">
